...
$VTR_ROOT/vtr_flow/scripts/run_vtr_flow.py  $VTR_ROOT/vtr_work/verilog_files/sparse_gemm_all_levels_mapped_to_DSPs.v \
$VTR_ROOT/vtr_work/arch_files_xml/$arch_file \
-temp_dir $VTR_ROOT/vtr_work/out_dir/sparse_gemm_all_levels_mapped_to_DSPs  \
