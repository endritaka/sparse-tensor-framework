import subprocess
import random
from verilog_auto_code_dense_gemm_Aman_like import gen_verilog_dense_gemm_Aman_like
...
verilog_file = "dense_gemm_Aman_like.v"

#specify the parent dir
parent_dir = "mult_seeds_dense_gemm_Aman_like"
...
for x_y in range(3, 11):
    ...
    for i in range(num_runs):
        ...
        gen_verilog_dense_gemm_Aman_like(X, Y, K, U, V)
