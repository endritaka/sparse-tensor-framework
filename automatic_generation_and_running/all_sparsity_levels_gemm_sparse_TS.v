...
assign A_in0_0 = A0_data;
assign A_in0_1 = A1_data;
assign A_in0_2 = A2_data;
assign A_in0_3 = A3_data;
assign A_in0_4 = A4_data;
assign A_in0_5 = A5_data;
assign A_in0_6 = A6_data;
assign A_in0_7 = A7_data;
assign A_in0_8 = A8_data;
assign A_in0_9 = A9_data;
...
assign B_in0_0 = B0_data;
assign B_in1_0 = B1_data;
assign B_in2_0 = B2_data;
assign B_in3_0 = B3_data;
assign B_in4_0 = B4_data;
assign B_in5_0 = B5_data;
assign B_in6_0 = B6_data;
assign B_in7_0 = B7_data;
assign B_in8_0 = B8_data;
assign B_in9_0 = B9_data;
...
// TS_xy
sparse_dense_init TS_0_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_0), .b_data(B_in0_0), .a_data_out(A_out0_0_in1_0), .c_data(C0_0_data),
						 .accumulate_out(acc_out0_0_acc_in1_0), .valid_out(valid_out0_0), .b_ded_out(B_out0_0_in0_1));

sparse_dense_middle TS_0_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_1), .a_data_out(A_out0_1_in1_1), .c_data(C0_1_data), .accumulate_out(), .valid_out(valid_out0_1),
						 .b_ded_in(B_out0_0_in0_1), .b_ded_out(B_out0_1_in0_2));

sparse_dense_middle TS_0_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_2), .a_data_out(A_out0_2_in1_2), .c_data(C0_2_data), .accumulate_out(), .valid_out(valid_out0_2),
						 .b_ded_in(B_out0_1_in0_2), .b_ded_out(B_out0_2_in0_3));

sparse_dense_middle TS_0_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_3), .a_data_out(A_out0_3_in1_3), .c_data(C0_3_data), .accumulate_out(), .valid_out(valid_out0_3),
						 .b_ded_in(B_out0_2_in0_3), .b_ded_out(B_out0_3_in0_4));

sparse_dense_middle TS_0_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_4), .a_data_out(A_out0_4_in1_4), .c_data(C0_4_data), .accumulate_out(), .valid_out(valid_out0_4),
						 .b_ded_in(B_out0_3_in0_4), .b_ded_out(B_out0_4_in0_5));

sparse_dense_middle TS_0_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_5), .a_data_out(A_out0_5_in1_5), .c_data(C0_5_data), .accumulate_out(), .valid_out(valid_out0_5),
						 .b_ded_in(B_out0_4_in0_5), .b_ded_out(B_out0_5_in0_6));

sparse_dense_middle TS_0_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_6), .a_data_out(A_out0_6_in1_6), .c_data(C0_6_data), .accumulate_out(), .valid_out(valid_out0_6),
						 .b_ded_in(B_out0_5_in0_6), .b_ded_out(B_out0_6_in0_7));

sparse_dense_middle TS_0_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_7), .a_data_out(A_out0_7_in1_7), .c_data(C0_7_data), .accumulate_out(), .valid_out(valid_out0_7),
						 .b_ded_in(B_out0_6_in0_7), .b_ded_out(B_out0_7_in0_8));

sparse_dense_middle TS_0_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_8), .a_data_out(A_out0_8_in1_8), .c_data(C0_8_data), .accumulate_out(), .valid_out(valid_out0_8),
						 .b_ded_in(B_out0_7_in0_8), .b_ded_out(B_out0_8_in0_9));

sparse_dense_last TS_0_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_9), .a_data_out(A_out0_9_in1_9), .c_data(C0_9_data), .accumulate_out(),
						 .valid_out(valid_out0_9), .b_ded_in(B_out0_8_in0_9));

sparse_dense_init TS_1_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out0_0_acc_in1_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_0_in1_0), .b_data(B_in1_0), .a_data_out(A_out1_0_in2_0), .c_data(C1_0_data),
						 .accumulate_out(acc_out1_0_acc_in2_0), .valid_out(valid_out1_0), .b_ded_out(B_out1_0_in1_1));

sparse_dense_middle TS_1_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_1_in1_1), .a_data_out(A_out1_1_in2_1), .c_data(C1_1_data), .accumulate_out(), .valid_out(valid_out1_1),
						 .b_ded_in(B_out1_0_in1_1), .b_ded_out(B_out1_1_in1_2));

sparse_dense_middle TS_1_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_2_in1_2), .a_data_out(A_out1_2_in2_2), .c_data(C1_2_data), .accumulate_out(), .valid_out(valid_out1_2),
						 .b_ded_in(B_out1_1_in1_2), .b_ded_out(B_out1_2_in1_3));

sparse_dense_middle TS_1_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_3_in1_3), .a_data_out(A_out1_3_in2_3), .c_data(C1_3_data), .accumulate_out(), .valid_out(valid_out1_3),
						 .b_ded_in(B_out1_2_in1_3), .b_ded_out(B_out1_3_in1_4));

sparse_dense_middle TS_1_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_4_in1_4), .a_data_out(A_out1_4_in2_4), .c_data(C1_4_data), .accumulate_out(), .valid_out(valid_out1_4),
						 .b_ded_in(B_out1_3_in1_4), .b_ded_out(B_out1_4_in1_5));

sparse_dense_middle TS_1_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_5_in1_5), .a_data_out(A_out1_5_in2_5), .c_data(C1_5_data), .accumulate_out(), .valid_out(valid_out1_5),
						 .b_ded_in(B_out1_4_in1_5), .b_ded_out(B_out1_5_in1_6));

sparse_dense_middle TS_1_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_6_in1_6), .a_data_out(A_out1_6_in2_6), .c_data(C1_6_data), .accumulate_out(), .valid_out(valid_out1_6),
						 .b_ded_in(B_out1_5_in1_6), .b_ded_out(B_out1_6_in1_7));

sparse_dense_middle TS_1_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_7_in1_7), .a_data_out(A_out1_7_in2_7), .c_data(C1_7_data), .accumulate_out(), .valid_out(valid_out1_7),
						 .b_ded_in(B_out1_6_in1_7), .b_ded_out(B_out1_7_in1_8));

sparse_dense_middle TS_1_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_8_in1_8), .a_data_out(A_out1_8_in2_8), .c_data(C1_8_data), .accumulate_out(), .valid_out(valid_out1_8),
						 .b_ded_in(B_out1_7_in1_8), .b_ded_out(B_out1_8_in1_9));

sparse_dense_last TS_1_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_9_in1_9), .a_data_out(A_out1_9_in2_9), .c_data(C1_9_data), .accumulate_out(),
						 .valid_out(valid_out1_9), .b_ded_in(B_out1_8_in1_9));

sparse_dense_init TS_2_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out1_0_acc_in2_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_0_in2_0), .b_data(B_in2_0), .a_data_out(A_out2_0_in3_0), .c_data(C2_0_data),
						 .accumulate_out(acc_out2_0_acc_in3_0), .valid_out(valid_out2_0), .b_ded_out(B_out2_0_in2_1));

sparse_dense_middle TS_2_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_1_in2_1), .a_data_out(A_out2_1_in3_1), .c_data(C2_1_data), .accumulate_out(), .valid_out(valid_out2_1),
						 .b_ded_in(B_out2_0_in2_1), .b_ded_out(B_out2_1_in2_2));

sparse_dense_middle TS_2_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_2_in2_2), .a_data_out(A_out2_2_in3_2), .c_data(C2_2_data), .accumulate_out(), .valid_out(valid_out2_2),
						 .b_ded_in(B_out2_1_in2_2), .b_ded_out(B_out2_2_in2_3));

sparse_dense_middle TS_2_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_3_in2_3), .a_data_out(A_out2_3_in3_3), .c_data(C2_3_data), .accumulate_out(), .valid_out(valid_out2_3),
						 .b_ded_in(B_out2_2_in2_3), .b_ded_out(B_out2_3_in2_4));

sparse_dense_middle TS_2_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_4_in2_4), .a_data_out(A_out2_4_in3_4), .c_data(C2_4_data), .accumulate_out(), .valid_out(valid_out2_4),
						 .b_ded_in(B_out2_3_in2_4), .b_ded_out(B_out2_4_in2_5));

sparse_dense_middle TS_2_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_5_in2_5), .a_data_out(A_out2_5_in3_5), .c_data(C2_5_data), .accumulate_out(), .valid_out(valid_out2_5),
						 .b_ded_in(B_out2_4_in2_5), .b_ded_out(B_out2_5_in2_6));

sparse_dense_middle TS_2_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_6_in2_6), .a_data_out(A_out2_6_in3_6), .c_data(C2_6_data), .accumulate_out(), .valid_out(valid_out2_6),
						 .b_ded_in(B_out2_5_in2_6), .b_ded_out(B_out2_6_in2_7));

sparse_dense_middle TS_2_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_7_in2_7), .a_data_out(A_out2_7_in3_7), .c_data(C2_7_data), .accumulate_out(), .valid_out(valid_out2_7),
						 .b_ded_in(B_out2_6_in2_7), .b_ded_out(B_out2_7_in2_8));

sparse_dense_middle TS_2_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_8_in2_8), .a_data_out(A_out2_8_in3_8), .c_data(C2_8_data), .accumulate_out(), .valid_out(valid_out2_8),
						 .b_ded_in(B_out2_7_in2_8), .b_ded_out(B_out2_8_in2_9));

sparse_dense_last TS_2_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_9_in2_9), .a_data_out(A_out2_9_in3_9), .c_data(C2_9_data), .accumulate_out(),
						 .valid_out(valid_out2_9), .b_ded_in(B_out2_8_in2_9));

sparse_dense_init TS_3_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out2_0_acc_in3_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_0_in3_0), .b_data(B_in3_0), .a_data_out(A_out3_0_in4_0), .c_data(C3_0_data),
						 .accumulate_out(acc_out3_0_acc_in4_0), .valid_out(valid_out3_0), .b_ded_out(B_out3_0_in3_1));

sparse_dense_middle TS_3_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_1_in3_1), .a_data_out(A_out3_1_in4_1), .c_data(C3_1_data), .accumulate_out(), .valid_out(valid_out3_1),
						 .b_ded_in(B_out3_0_in3_1), .b_ded_out(B_out3_1_in3_2));

sparse_dense_middle TS_3_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_2_in3_2), .a_data_out(A_out3_2_in4_2), .c_data(C3_2_data), .accumulate_out(), .valid_out(valid_out3_2),
						 .b_ded_in(B_out3_1_in3_2), .b_ded_out(B_out3_2_in3_3));

sparse_dense_middle TS_3_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_3_in3_3), .a_data_out(A_out3_3_in4_3), .c_data(C3_3_data), .accumulate_out(), .valid_out(valid_out3_3),
						 .b_ded_in(B_out3_2_in3_3), .b_ded_out(B_out3_3_in3_4));

sparse_dense_middle TS_3_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_4_in3_4), .a_data_out(A_out3_4_in4_4), .c_data(C3_4_data), .accumulate_out(), .valid_out(valid_out3_4),
						 .b_ded_in(B_out3_3_in3_4), .b_ded_out(B_out3_4_in3_5));

sparse_dense_middle TS_3_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_5_in3_5), .a_data_out(A_out3_5_in4_5), .c_data(C3_5_data), .accumulate_out(), .valid_out(valid_out3_5),
						 .b_ded_in(B_out3_4_in3_5), .b_ded_out(B_out3_5_in3_6));

sparse_dense_middle TS_3_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_6_in3_6), .a_data_out(A_out3_6_in4_6), .c_data(C3_6_data), .accumulate_out(), .valid_out(valid_out3_6),
						 .b_ded_in(B_out3_5_in3_6), .b_ded_out(B_out3_6_in3_7));

sparse_dense_middle TS_3_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_7_in3_7), .a_data_out(A_out3_7_in4_7), .c_data(C3_7_data), .accumulate_out(), .valid_out(valid_out3_7),
						 .b_ded_in(B_out3_6_in3_7), .b_ded_out(B_out3_7_in3_8));

sparse_dense_middle TS_3_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_8_in3_8), .a_data_out(A_out3_8_in4_8), .c_data(C3_8_data), .accumulate_out(), .valid_out(valid_out3_8),
						 .b_ded_in(B_out3_7_in3_8), .b_ded_out(B_out3_8_in3_9));

sparse_dense_last TS_3_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_9_in3_9), .a_data_out(A_out3_9_in4_9), .c_data(C3_9_data), .accumulate_out(),
						 .valid_out(valid_out3_9), .b_ded_in(B_out3_8_in3_9));

sparse_dense_init TS_4_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out3_0_acc_in4_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_0_in4_0), .b_data(B_in4_0), .a_data_out(A_out4_0_in5_0), .c_data(C4_0_data),
						 .accumulate_out(acc_out4_0_acc_in5_0), .valid_out(valid_out4_0), .b_ded_out(B_out4_0_in4_1));

sparse_dense_middle TS_4_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_1_in4_1), .a_data_out(A_out4_1_in5_1), .c_data(C4_1_data), .accumulate_out(), .valid_out(valid_out4_1),
						 .b_ded_in(B_out4_0_in4_1), .b_ded_out(B_out4_1_in4_2));

sparse_dense_middle TS_4_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_2_in4_2), .a_data_out(A_out4_2_in5_2), .c_data(C4_2_data), .accumulate_out(), .valid_out(valid_out4_2),
						 .b_ded_in(B_out4_1_in4_2), .b_ded_out(B_out4_2_in4_3));

sparse_dense_middle TS_4_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_3_in4_3), .a_data_out(A_out4_3_in5_3), .c_data(C4_3_data), .accumulate_out(), .valid_out(valid_out4_3),
						 .b_ded_in(B_out4_2_in4_3), .b_ded_out(B_out4_3_in4_4));

sparse_dense_middle TS_4_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_4_in4_4), .a_data_out(A_out4_4_in5_4), .c_data(C4_4_data), .accumulate_out(), .valid_out(valid_out4_4),
						 .b_ded_in(B_out4_3_in4_4), .b_ded_out(B_out4_4_in4_5));

sparse_dense_middle TS_4_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_5_in4_5), .a_data_out(A_out4_5_in5_5), .c_data(C4_5_data), .accumulate_out(), .valid_out(valid_out4_5),
						 .b_ded_in(B_out4_4_in4_5), .b_ded_out(B_out4_5_in4_6));

sparse_dense_middle TS_4_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_6_in4_6), .a_data_out(A_out4_6_in5_6), .c_data(C4_6_data), .accumulate_out(), .valid_out(valid_out4_6),
						 .b_ded_in(B_out4_5_in4_6), .b_ded_out(B_out4_6_in4_7));

sparse_dense_middle TS_4_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_7_in4_7), .a_data_out(A_out4_7_in5_7), .c_data(C4_7_data), .accumulate_out(), .valid_out(valid_out4_7),
						 .b_ded_in(B_out4_6_in4_7), .b_ded_out(B_out4_7_in4_8));

sparse_dense_middle TS_4_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_8_in4_8), .a_data_out(A_out4_8_in5_8), .c_data(C4_8_data), .accumulate_out(), .valid_out(valid_out4_8),
						 .b_ded_in(B_out4_7_in4_8), .b_ded_out(B_out4_8_in4_9));

sparse_dense_last TS_4_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in4_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out3_9_in4_9), .a_data_out(A_out4_9_in5_9), .c_data(C4_9_data), .accumulate_out(),
						 .valid_out(valid_out4_9), .b_ded_in(B_out4_8_in4_9));

sparse_dense_init TS_5_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out4_0_acc_in5_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_0_in5_0), .b_data(B_in5_0), .a_data_out(A_out5_0_in6_0), .c_data(C5_0_data),
						 .accumulate_out(acc_out5_0_acc_in6_0), .valid_out(valid_out5_0), .b_ded_out(B_out5_0_in5_1));

sparse_dense_middle TS_5_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_1_in5_1), .a_data_out(A_out5_1_in6_1), .c_data(C5_1_data), .accumulate_out(), .valid_out(valid_out5_1),
						 .b_ded_in(B_out5_0_in5_1), .b_ded_out(B_out5_1_in5_2));

sparse_dense_middle TS_5_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_2_in5_2), .a_data_out(A_out5_2_in6_2), .c_data(C5_2_data), .accumulate_out(), .valid_out(valid_out5_2),
						 .b_ded_in(B_out5_1_in5_2), .b_ded_out(B_out5_2_in5_3));

sparse_dense_middle TS_5_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_3_in5_3), .a_data_out(A_out5_3_in6_3), .c_data(C5_3_data), .accumulate_out(), .valid_out(valid_out5_3),
						 .b_ded_in(B_out5_2_in5_3), .b_ded_out(B_out5_3_in5_4));

sparse_dense_middle TS_5_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_4_in5_4), .a_data_out(A_out5_4_in6_4), .c_data(C5_4_data), .accumulate_out(), .valid_out(valid_out5_4),
						 .b_ded_in(B_out5_3_in5_4), .b_ded_out(B_out5_4_in5_5));

sparse_dense_middle TS_5_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_5_in5_5), .a_data_out(A_out5_5_in6_5), .c_data(C5_5_data), .accumulate_out(), .valid_out(valid_out5_5),
						 .b_ded_in(B_out5_4_in5_5), .b_ded_out(B_out5_5_in5_6));

sparse_dense_middle TS_5_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_6_in5_6), .a_data_out(A_out5_6_in6_6), .c_data(C5_6_data), .accumulate_out(), .valid_out(valid_out5_6),
						 .b_ded_in(B_out5_5_in5_6), .b_ded_out(B_out5_6_in5_7));

sparse_dense_middle TS_5_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_7_in5_7), .a_data_out(A_out5_7_in6_7), .c_data(C5_7_data), .accumulate_out(), .valid_out(valid_out5_7),
						 .b_ded_in(B_out5_6_in5_7), .b_ded_out(B_out5_7_in5_8));

sparse_dense_middle TS_5_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_8_in5_8), .a_data_out(A_out5_8_in6_8), .c_data(C5_8_data), .accumulate_out(), .valid_out(valid_out5_8),
						 .b_ded_in(B_out5_7_in5_8), .b_ded_out(B_out5_8_in5_9));

sparse_dense_last TS_5_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in5_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out4_9_in5_9), .a_data_out(A_out5_9_in6_9), .c_data(C5_9_data), .accumulate_out(),
						 .valid_out(valid_out5_9), .b_ded_in(B_out5_8_in5_9));

sparse_dense_init TS_6_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out5_0_acc_in6_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_0_in6_0), .b_data(B_in6_0), .a_data_out(A_out6_0_in7_0), .c_data(C6_0_data),
						 .accumulate_out(acc_out6_0_acc_in7_0), .valid_out(valid_out6_0), .b_ded_out(B_out6_0_in6_1));

sparse_dense_middle TS_6_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_1_in6_1), .a_data_out(A_out6_1_in7_1), .c_data(C6_1_data), .accumulate_out(), .valid_out(valid_out6_1),
						 .b_ded_in(B_out6_0_in6_1), .b_ded_out(B_out6_1_in6_2));

sparse_dense_middle TS_6_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_2_in6_2), .a_data_out(A_out6_2_in7_2), .c_data(C6_2_data), .accumulate_out(), .valid_out(valid_out6_2),
						 .b_ded_in(B_out6_1_in6_2), .b_ded_out(B_out6_2_in6_3));

sparse_dense_middle TS_6_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_3_in6_3), .a_data_out(A_out6_3_in7_3), .c_data(C6_3_data), .accumulate_out(), .valid_out(valid_out6_3),
						 .b_ded_in(B_out6_2_in6_3), .b_ded_out(B_out6_3_in6_4));

sparse_dense_middle TS_6_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_4_in6_4), .a_data_out(A_out6_4_in7_4), .c_data(C6_4_data), .accumulate_out(), .valid_out(valid_out6_4),
						 .b_ded_in(B_out6_3_in6_4), .b_ded_out(B_out6_4_in6_5));

sparse_dense_middle TS_6_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_5_in6_5), .a_data_out(A_out6_5_in7_5), .c_data(C6_5_data), .accumulate_out(), .valid_out(valid_out6_5),
						 .b_ded_in(B_out6_4_in6_5), .b_ded_out(B_out6_5_in6_6));

sparse_dense_middle TS_6_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_6_in6_6), .a_data_out(A_out6_6_in7_6), .c_data(C6_6_data), .accumulate_out(), .valid_out(valid_out6_6),
						 .b_ded_in(B_out6_5_in6_6), .b_ded_out(B_out6_6_in6_7));

sparse_dense_middle TS_6_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_7_in6_7), .a_data_out(A_out6_7_in7_7), .c_data(C6_7_data), .accumulate_out(), .valid_out(valid_out6_7),
						 .b_ded_in(B_out6_6_in6_7), .b_ded_out(B_out6_7_in6_8));

sparse_dense_middle TS_6_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_8_in6_8), .a_data_out(A_out6_8_in7_8), .c_data(C6_8_data), .accumulate_out(), .valid_out(valid_out6_8),
						 .b_ded_in(B_out6_7_in6_8), .b_ded_out(B_out6_8_in6_9));

sparse_dense_last TS_6_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in6_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out5_9_in6_9), .a_data_out(A_out6_9_in7_9), .c_data(C6_9_data), .accumulate_out(),
						 .valid_out(valid_out6_9), .b_ded_in(B_out6_8_in6_9));

sparse_dense_init TS_7_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out6_0_acc_in7_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_0_in7_0), .b_data(B_in7_0), .a_data_out(A_out7_0_in8_0), .c_data(C7_0_data),
						 .accumulate_out(acc_out7_0_acc_in8_0), .valid_out(valid_out7_0), .b_ded_out(B_out7_0_in7_1));

sparse_dense_middle TS_7_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_1_in7_1), .a_data_out(A_out7_1_in8_1), .c_data(C7_1_data), .accumulate_out(), .valid_out(valid_out7_1),
						 .b_ded_in(B_out7_0_in7_1), .b_ded_out(B_out7_1_in7_2));

sparse_dense_middle TS_7_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_2_in7_2), .a_data_out(A_out7_2_in8_2), .c_data(C7_2_data), .accumulate_out(), .valid_out(valid_out7_2),
						 .b_ded_in(B_out7_1_in7_2), .b_ded_out(B_out7_2_in7_3));

sparse_dense_middle TS_7_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_3_in7_3), .a_data_out(A_out7_3_in8_3), .c_data(C7_3_data), .accumulate_out(), .valid_out(valid_out7_3),
						 .b_ded_in(B_out7_2_in7_3), .b_ded_out(B_out7_3_in7_4));

sparse_dense_middle TS_7_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_4_in7_4), .a_data_out(A_out7_4_in8_4), .c_data(C7_4_data), .accumulate_out(), .valid_out(valid_out7_4),
						 .b_ded_in(B_out7_3_in7_4), .b_ded_out(B_out7_4_in7_5));

sparse_dense_middle TS_7_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_5_in7_5), .a_data_out(A_out7_5_in8_5), .c_data(C7_5_data), .accumulate_out(), .valid_out(valid_out7_5),
						 .b_ded_in(B_out7_4_in7_5), .b_ded_out(B_out7_5_in7_6));

sparse_dense_middle TS_7_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_6_in7_6), .a_data_out(A_out7_6_in8_6), .c_data(C7_6_data), .accumulate_out(), .valid_out(valid_out7_6),
						 .b_ded_in(B_out7_5_in7_6), .b_ded_out(B_out7_6_in7_7));

sparse_dense_middle TS_7_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_7_in7_7), .a_data_out(A_out7_7_in8_7), .c_data(C7_7_data), .accumulate_out(), .valid_out(valid_out7_7),
						 .b_ded_in(B_out7_6_in7_7), .b_ded_out(B_out7_7_in7_8));

sparse_dense_middle TS_7_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_8_in7_8), .a_data_out(A_out7_8_in8_8), .c_data(C7_8_data), .accumulate_out(), .valid_out(valid_out7_8),
						 .b_ded_in(B_out7_7_in7_8), .b_ded_out(B_out7_8_in7_9));

sparse_dense_last TS_7_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in7_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out6_9_in7_9), .a_data_out(A_out7_9_in8_9), .c_data(C7_9_data), .accumulate_out(),
						 .valid_out(valid_out7_9), .b_ded_in(B_out7_8_in7_9));

sparse_dense_init TS_8_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out7_0_acc_in8_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_0_in8_0), .b_data(B_in8_0), .a_data_out(A_out8_0_in9_0), .c_data(C8_0_data),
						 .accumulate_out(acc_out8_0_acc_in9_0), .valid_out(valid_out8_0), .b_ded_out(B_out8_0_in8_1));

sparse_dense_middle TS_8_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_1_in8_1), .a_data_out(A_out8_1_in9_1), .c_data(C8_1_data), .accumulate_out(), .valid_out(valid_out8_1),
						 .b_ded_in(B_out8_0_in8_1), .b_ded_out(B_out8_1_in8_2));

sparse_dense_middle TS_8_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_2_in8_2), .a_data_out(A_out8_2_in9_2), .c_data(C8_2_data), .accumulate_out(), .valid_out(valid_out8_2),
						 .b_ded_in(B_out8_1_in8_2), .b_ded_out(B_out8_2_in8_3));

sparse_dense_middle TS_8_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_3_in8_3), .a_data_out(A_out8_3_in9_3), .c_data(C8_3_data), .accumulate_out(), .valid_out(valid_out8_3),
						 .b_ded_in(B_out8_2_in8_3), .b_ded_out(B_out8_3_in8_4));

sparse_dense_middle TS_8_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_4_in8_4), .a_data_out(A_out8_4_in9_4), .c_data(C8_4_data), .accumulate_out(), .valid_out(valid_out8_4),
						 .b_ded_in(B_out8_3_in8_4), .b_ded_out(B_out8_4_in8_5));

sparse_dense_middle TS_8_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_5_in8_5), .a_data_out(A_out8_5_in9_5), .c_data(C8_5_data), .accumulate_out(), .valid_out(valid_out8_5),
						 .b_ded_in(B_out8_4_in8_5), .b_ded_out(B_out8_5_in8_6));

sparse_dense_middle TS_8_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_6_in8_6), .a_data_out(A_out8_6_in9_6), .c_data(C8_6_data), .accumulate_out(), .valid_out(valid_out8_6),
						 .b_ded_in(B_out8_5_in8_6), .b_ded_out(B_out8_6_in8_7));

sparse_dense_middle TS_8_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_7_in8_7), .a_data_out(A_out8_7_in9_7), .c_data(C8_7_data), .accumulate_out(), .valid_out(valid_out8_7),
						 .b_ded_in(B_out8_6_in8_7), .b_ded_out(B_out8_7_in8_8));

sparse_dense_middle TS_8_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_8_in8_8), .a_data_out(A_out8_8_in9_8), .c_data(C8_8_data), .accumulate_out(), .valid_out(valid_out8_8),
						 .b_ded_in(B_out8_7_in8_8), .b_ded_out(B_out8_8_in8_9));

sparse_dense_last TS_8_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in8_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out7_9_in8_9), .a_data_out(A_out8_9_in9_9), .c_data(C8_9_data), .accumulate_out(),
						 .valid_out(valid_out8_9), .b_ded_in(B_out8_8_in8_9));

sparse_dense_init TS_9_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out8_0_acc_in9_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_0_in9_0), .b_data(B_in9_0), .a_data_out(), .c_data(C9_0_data),
						 .accumulate_out(), .valid_out(valid_out9_0), .b_ded_out(B_out9_0_in9_1));

sparse_dense_middle TS_9_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_1_in9_1), .a_data_out(), .c_data(C9_1_data), .accumulate_out(), .valid_out(valid_out9_1),
						 .b_ded_in(B_out9_0_in9_1), .b_ded_out(B_out9_1_in9_2));

sparse_dense_middle TS_9_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_2_in9_2), .a_data_out(), .c_data(C9_2_data), .accumulate_out(), .valid_out(valid_out9_2),
						 .b_ded_in(B_out9_1_in9_2), .b_ded_out(B_out9_2_in9_3));

sparse_dense_middle TS_9_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_3_in9_3), .a_data_out(), .c_data(C9_3_data), .accumulate_out(), .valid_out(valid_out9_3),
						 .b_ded_in(B_out9_2_in9_3), .b_ded_out(B_out9_3_in9_4));

sparse_dense_middle TS_9_4 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_4), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_4_in9_4), .a_data_out(), .c_data(C9_4_data), .accumulate_out(), .valid_out(valid_out9_4),
						 .b_ded_in(B_out9_3_in9_4), .b_ded_out(B_out9_4_in9_5));

sparse_dense_middle TS_9_5 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_5), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_5_in9_5), .a_data_out(), .c_data(C9_5_data), .accumulate_out(), .valid_out(valid_out9_5),
						 .b_ded_in(B_out9_4_in9_5), .b_ded_out(B_out9_5_in9_6));

sparse_dense_middle TS_9_6 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_6), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_6_in9_6), .a_data_out(), .c_data(C9_6_data), .accumulate_out(), .valid_out(valid_out9_6),
						 .b_ded_in(B_out9_5_in9_6), .b_ded_out(B_out9_6_in9_7));

sparse_dense_middle TS_9_7 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_7), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_7_in9_7), .a_data_out(), .c_data(C9_7_data), .accumulate_out(), .valid_out(valid_out9_7),
						 .b_ded_in(B_out9_6_in9_7), .b_ded_out(B_out9_7_in9_8));

sparse_dense_middle TS_9_8 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_8), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_8_in9_8), .a_data_out(), .c_data(C9_8_data), .accumulate_out(), .valid_out(valid_out9_8),
						 .b_ded_in(B_out9_7_in9_8), .b_ded_out(B_out9_8_in9_9));

sparse_dense_last TS_9_9 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in9_9), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out8_9_in9_9), .a_data_out(), .c_data(C9_9_data), .accumulate_out(),
