...
$VTR_ROOT/vtr_work/out_dir/dense_gemm_Aman_like/dense_gemm_Aman_like \
--circuit_file $VTR_ROOT/vtr_work/out_dir/dense_gemm_Aman_like/dense_gemm_Aman_like.pre-vpr.blif \
