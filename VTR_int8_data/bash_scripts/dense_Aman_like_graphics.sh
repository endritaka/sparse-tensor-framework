...
$VTR_ROOT/vtr_work/out_dir/dense_Aman_like/dense_tensor_slice_Aman_like \
--circuit_file $VTR_ROOT/vtr_work/out_dir/dense_Aman_like/dense_tensor_slice_Aman_like.pre-vpr.blif \
