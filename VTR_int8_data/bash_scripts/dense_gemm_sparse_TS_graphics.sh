...
$VTR_ROOT/vtr_work/out_dir/dense_gemm_sparse_TS/dense_gemm_sparse_TS \
--circuit_file $VTR_ROOT/vtr_work/out_dir/dense_gemm_sparse_TS/dense_gemm_sparse_TS.pre-vpr.blif \
