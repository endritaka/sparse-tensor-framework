...
sparse_dense_last TS_0_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in0_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_in0_3), .a_data_out(A_out0_3_in1_3), .c_data(C0_3_data), .accumulate_out(),
						 .valid_out(valid_out0_3), .b_ded_in(B_out0_2_in0_3));
...
sparse_dense_last TS_1_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in1_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out0_3_in1_3), .a_data_out(A_out1_3_in2_3), .c_data(C1_3_data), .accumulate_out(),
						 .valid_out(valid_out1_3), .b_ded_in(B_out1_2_in1_3));
...
sparse_dense_last TS_2_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in2_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out1_3_in2_3), .a_data_out(A_out2_3_in3_3), .c_data(C2_3_data), .accumulate_out(),
						 .valid_out(valid_out2_3), .b_ded_in(B_out2_2_in2_3));
...
sparse_dense_init TS_3_0 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_out2_0_acc_in3_0), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_0_in3_0), .b_data(B_in3_0), .a_data_out(), .c_data(C3_0_data),
						 .accumulate_out(), .valid_out(valid_out3_0), .b_ded_out(B_out3_0_in3_1));

sparse_dense_middle TS_3_1 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_1), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_1_in3_1), .a_data_out(), .c_data(C3_1_data), .accumulate_out(), .valid_out(valid_out3_1),
...
sparse_dense_middle TS_3_2 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_2), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_2_in3_2), .a_data_out(), .c_data(C3_2_data), .accumulate_out(), .valid_out(valid_out3_2),
						 .b_ded_in(B_out3_1_in3_2), .b_ded_out(B_out3_2_in3_3));

sparse_dense_last TS_3_3 (.clk(clk), .reset(reset), .enable(enable), .accumulate(acc_in3_3), .K_size(`K), .sparsity_level(sparsity_level),
						 .a_data(A_out2_3_in3_3), .a_data_out(), .c_data(C3_3_data), .accumulate_out(),
						 .valid_out(valid_out3_3), .b_ded_in(B_out3_2_in3_3));
...
assign cout_data[16] = &C1_0_data_out_mem[31:0];
assign cout_data[17] = &C1_0_data_out_mem[63:32];
assign cout_data[18] = &C1_0_data_out_mem[95:64];
assign cout_data[19] = &C1_0_data_out_mem[127:96];

assign cout_data[20] = &C1_1_data_out_mem[31:0];
assign cout_data[21] = &C1_1_data_out_mem[63:32];
assign cout_data[22] = &C1_1_data_out_mem[95:64];
assign cout_data[23] = &C1_1_data_out_mem[127:96];

assign cout_data[24] = &C1_2_data_out_mem[31:0];
assign cout_data[25] = &C1_2_data_out_mem[63:32];
assign cout_data[26] = &C1_2_data_out_mem[95:64];
assign cout_data[27] = &C1_2_data_out_mem[127:96];

assign cout_data[28] = &C1_3_data_out_mem[31:0];
assign cout_data[29] = &C1_3_data_out_mem[63:32];
assign cout_data[30] = &C1_3_data_out_mem[95:64];
assign cout_data[31] = &C1_3_data_out_mem[127:96];

assign cout_data[32] = &C2_0_data_out_mem[31:0];
assign cout_data[33] = &C2_0_data_out_mem[63:32];
assign cout_data[34] = &C2_0_data_out_mem[95:64];
assign cout_data[35] = &C2_0_data_out_mem[127:96];

assign cout_data[36] = &C2_1_data_out_mem[31:0];
assign cout_data[37] = &C2_1_data_out_mem[63:32];
assign cout_data[38] = &C2_1_data_out_mem[95:64];
assign cout_data[39] = &C2_1_data_out_mem[127:96];

assign cout_data[40] = &C2_2_data_out_mem[31:0];
assign cout_data[41] = &C2_2_data_out_mem[63:32];
assign cout_data[42] = &C2_2_data_out_mem[95:64];
assign cout_data[43] = &C2_2_data_out_mem[127:96];

assign cout_data[44] = &C2_3_data_out_mem[31:0];
assign cout_data[45] = &C2_3_data_out_mem[63:32];
assign cout_data[46] = &C2_3_data_out_mem[95:64];
assign cout_data[47] = &C2_3_data_out_mem[127:96];

assign cout_data[48] = &C3_0_data_out_mem[31:0];
assign cout_data[49] = &C3_0_data_out_mem[63:32];
assign cout_data[50] = &C3_0_data_out_mem[95:64];
assign cout_data[51] = &C3_0_data_out_mem[127:96];

assign cout_data[52] = &C3_1_data_out_mem[31:0];
assign cout_data[53] = &C3_1_data_out_mem[63:32];
assign cout_data[54] = &C3_1_data_out_mem[95:64];
assign cout_data[55] = &C3_1_data_out_mem[127:96];

assign cout_data[56] = &C3_2_data_out_mem[31:0];
assign cout_data[57] = &C3_2_data_out_mem[63:32];
assign cout_data[58] = &C3_2_data_out_mem[95:64];
assign cout_data[59] = &C3_2_data_out_mem[127:96];

assign cout_data[60] = &C3_3_data_out_mem[31:0];
assign cout_data[61] = &C3_3_data_out_mem[63:32];
assign cout_data[62] = &C3_3_data_out_mem[95:64];
assign cout_data[63] = &C3_3_data_out_mem[127:96];
