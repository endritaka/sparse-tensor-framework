...
dense_tensor_slice TS_0_2 (.clk(clk), .reset(reset), .a_data(A2_data), .a_data_in(a_data_in0_2), .b_data(b_data0_2),
						 .b_data_in(B_out0_1_in0_2), .a_data_out(A_out0_2_in1_2), .b_data_out(), .c_data(C0_2_data),
...
dense_tensor_slice TS_1_2 (.clk(clk), .reset(reset), .a_data(a_data1_2), .a_data_in(A_out0_2_in1_2), .b_data(b_data1_2),
						 .b_data_in(B_out1_1_in1_2), .a_data_out(A_out1_2_in2_2), .b_data_out(), .c_data(C1_2_data),
...
dense_tensor_slice TS_2_0 (.clk(clk), .reset(reset), .a_data(a_data2_0), .a_data_in(A_out1_0_in2_0), .b_data(B2_data),
						 .b_data_in(b_data_in2_0), .a_data_out(), .b_data_out(B_out2_0_in2_1), .c_data(C2_0_data),
						 .K_size(`K), .enable(enable), .accumulate(accumulate_out1_0),
...
dense_tensor_slice TS_2_1 (.clk(clk), .reset(reset), .a_data(a_data2_1), .a_data_in(A_out1_1_in2_1), .b_data(b_data2_1),
						 .b_data_in(B_out2_0_in2_1), .a_data_out(), .b_data_out(B_out2_1_in2_2), .c_data(C2_1_data),
...
dense_tensor_slice TS_2_2 (.clk(clk), .reset(reset), .a_data(a_data2_2), .a_data_in(A_out1_2_in2_2), .b_data(b_data2_2),
						 .b_data_in(B_out2_1_in2_2), .a_data_out(), .b_data_out(), .c_data(C2_2_data),
